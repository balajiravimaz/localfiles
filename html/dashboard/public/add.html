...
<body>
    <section id="sidemenu">
        ...
        <nav>
            ...
            <a href="add.html"><span><i class="fa fa-plus"></i> Add </span>
            </a>
            <a href="edit.html"><span><i class="fa fa-edit"></i> </span> Edit</a>
        ...
        <section id="area-content">
            ...
            <div class="container">
                <form method="post" enctype="multipart/form-data">
                    ...
                    <div class="col-md-3">
                        <label for="email">Doctrate</label>
                        <select id="doc">
                    ...
                    <div class="col-md-3">
                        <label for="image">Date of Joining</label>
